...
## [0.7.4] - 2026-05-12
- Improved schema scanning to avoid generating two classes (`Up` and `Down` version) for a model in some special circumstances.  

## [0.7.3] - 2026-04-08
- Fixed issue with identifying the discriminator property 

## [0.7.2] - 2026-04-08
- OneOf schemas with a discriminator property of type enum now works as expected 

## [0.7.1] - 2025-11-19
- Improved error reporting for test clients
